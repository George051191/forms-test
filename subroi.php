<?php
    ...
    $roistatData = array(
                         ...
                         'key'     => 'OGJjYWNmYzNhNzIwYTI5NDdlNDI3NGQ2OTM4YTA1MWY6MjE3NjU1', // Ключ для интеграции с CRM, указывается в настройках интеграции с CRM.
                         'title'   => 'New Lead',
                         'comment' => $comment,
                         'name'    => $name,
                         'email'   => $email,
                         ...
                         'callback_phone' => '79179415906', // Номер для обратного звонка
                         'sync'    => '0', //
